                    ...
                    <div className="flex flex-col lg:flex-row items-stretch">
                        ...
                        <div className="lg:w-3/5 relative overflow-hidden">
                            ...
                            <div className="absolute top-6 left-6 bg-white/95 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
                                <span className="font-bold text-[#304131] text-sm">COLECCIÓN EXCLUSIVA</span>
                            </div>
                        </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div>
                                    ...
                                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight">
                                        ...
                                        <span className="text-white/90 text-3xl md:text-4xl">Belleza Efímera</span>
                                    </h2>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <p className="text-white/90 text-lg leading-relaxed">
                                        Inspirada en la fugaz belleza de los cerezos en flor. Cada pieza captura la
                                        delicadeza y profundidad de la cultura japonesa.
                                    </p>
                                    <p className="text-white/80 text-lg leading-relaxed">
                                        Fabricadas con materiales que honran la tradición artesanal y detalles únicos
                                        que evocan la serenidad de los jardines japoneses.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                                    <div className="flex items-center justify-between mb-2">
                                        <span className="text-white/80 text-sm">Unidades disponibles</span>
                                        <span className="text-white font-bold">{remainingUnits}/100</span>
                                    </div>
